...
struct Feature2_1_1View: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("something \(feature2_1_1ViewModel.something ?? "")")
            Button {
                feature2_1_1ViewModel.something = "setted"
            } label: {
                Text("set something")
            }
            NavigationLink(value: Feature2_1_1ViewRoute.Feature2_1_1_1) {
                Text("go to Feature 2_1_1_1")
            }
        }
        .navigationDestination(for: Feature2_1_1ViewRoute.self) { _ in
            Feature2_1_1_1View(
